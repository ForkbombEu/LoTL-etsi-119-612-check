...
const CORE_REQUIREMENTS = [
  ...
  requirement("ts119602.syntax.country_code", "Country-code values", "Validate upper-case country codes, ISO 3166-1 values, and the defined UK, EL, EU, regional, and multi-state alternatives.", "syntax", "shall", "error", "local", [citation("6.1.5")]),
  requirement("ts119602.structure.lote_tag", "LoTE tag", "Validate the binding-specific representation and value of the LoTE tag.", "structure", "shall", "error", "local", [citation("6.2")]),
  requirement("ts119602.structure.scheme_information_presence", "Implicit and explicit scheme-information presence", "Apply the mandatory, optional, and prohibited component matrix for the selected scheme-information mode.", "structure", "shall", "critical", "local", [citation("6.3.0"), citation("Table 1", "Implicit and explicit scheme information")], "partial", ["json_lote.list_and_scheme_information", "xml_lote.structure.list_and_scheme_information"]),
  requirement("ts119602.scheme.version", "LoTE version identifier", "Validate the version identifier type and the value required by the selected profile and binding.", "semantic", "shall", "error", "local", [citation("6.3.1")], "partial", ["json_lote.version_identifier", "xml_lote.structure.version_identifier"]),
  requirement("ts119602.scheme.sequence.local", "LoTE sequence number", "Validate that the sequence number is an integer in the locally valid range.", "semantic", "shall", "error", "local", [citation("6.3.2")], "partial", ["json_lote.sequence_number", "xml_lote.structure.sequence_number"]),
  ...
  requirement("ts119602.scheme.operator_address", "Scheme operator address", "Validate postal and electronic address structure, languages, country, email, web, and telephone rules.", "semantic", "conditional", "error", "local", [citation("6.3.5"), citation("6.3.5.1"), citation("6.3.5.2")], "partial", ["xml_lote.structure.scheme_operator_address"]),
  requirement("ts119602.scheme.name", "Scheme name", "Validate the multilingual scheme name and the required territory/name form.", "semantic", "conditional", "error", "local", [citation("6.3.6")], "partial", ["xml_lote.structure.scheme_name"]),
  ...
  requirement("ts119602.scheme.policy_or_legal_notice", "Policy or legal notice", "Validate the multilingual policy text or pointer alternatives required for explicit scheme information.", "semantic", "conditional", "error", "mixed", [citation("6.3.11")], "partial", ["xml_lote.structure.policy_or_legal_notice"]),
  requirement("ts119602.scheme.history_period", "Historical information period", "Validate the integer history period, special value 65535, and consequences for service status and history.", "semantic", "conditional", "error", "local", [citation("6.3.12")]),
  requirement("ts119602.scheme.pointers.structure", "Pointers to other LoTEs", "Validate pointer location, one-or-more digital identities, qualifiers, and binding cardinalities.", "structure", "conditional", "error", "local", [citation("6.3.13")], "partial", ["json_lote.pointers.count", "json_lote.pointers.service_digital_identities"]),
  ...
  requirement("ts119602.scheme.issue_time", "List issue date and time", "Validate lexical form and issuance-time semantics.", "semantic", "shall", "error", "local", [citation("6.3.14")], "partial", ["json_lote.list_issue_date_time", "xml_lote.structure.list_issue_date_time"]),
  requirement("ts119602.scheme.next_update", "Next update and closed LoTE", "Validate ordering, expiry, profile update interval, and null semantics for a final closed LoTE.", "semantic", "mixed", "error", "mixed", [citation("6.3.15")], "partial", ["json_lote.dates.next_after_issue", "json_lote.dates.next_update_expired", "xml_lote.dates.next_after_issue"]),
  requirement("ts119602.scheme.distribution_points", "Distribution point structure", "Validate a non-empty sequence of distribution-point URIs when the component is present.", "structure", "conditional", "error", "local", [citation("6.3.16")], "partial", ["json_lote.distribution_points"]),
  ...
  requirement("ts119602.scheme.extensions", "Scheme extensions and criticality", "Validate extension criticality and reject unknown critical extensions.", "semantic", "conditional", "critical", "local", [citation("6.3.17")]),
  requirement("ts119602.entities.list", "Trusted entities list", "Validate presence or absence according to whether any entity service is or was approved, and validate non-empty entity structure.", "structure", "conditional", "critical", "local", [citation("6.4.0")], "partial", ["xml_lote.structure.trusted_entities_container", "xml_lote.services.trusted_entity_count"]),
  requirement("ts119602.entities.structure", "Trusted entity and service containers", "Validate TrustedEntityInformation, TrustedEntityServices, TrustedEntityService, and optional history nesting and cardinality.", "structure", "shall", "critical", "local", [citation("6.4.1"), citation("6.4.2"), citation("6.4.3"), citation("6.4.4")], "partial", ["xml_lote.services.entity.1.information", "xml_lote.services.entity.1.service_count"]),
  requirement("ts119602.entity.information", "Trusted entity information", "Validate mandatory name, address, information URI, optional trade name, and extensions.", "structure", "shall", "critical", "local", [citation("6.5.0")], "partial", ["xml_lote.services.entity.1.name", "xml_lote.services.entity.1.address"]),
  requirement("ts119602.entity.names", "Trusted entity names", "Validate legal or natural-person name and optional trade-name semantics.", "semantic", "mixed", "error", "local", [citation("6.5.1"), citation("6.5.2")], "partial", ["xml_lote.services.entity.1.name"]),
  requirement("ts119602.entity.address", "Trusted entity address", "Validate multilingual postal and electronic addresses and their contact semantics.", "semantic", "shall", "error", "local", [citation("6.5.3"), citation("6.5.3.1"), citation("6.5.3.2")], "partial", ["xml_lote.services.entity.1.address"]),
  requirement("ts119602.entity.information_uri", "Trusted entity information URI", "Validate mandatory multilingual pointers to information about the trusted entity.", "semantic", "shall", "error", "mixed", [citation("6.5.4")]),
  requirement("ts119602.entity.extensions", "Trusted entity and associated-body extensions", "Validate extension structure, criticality, and all selected-profile associated-body requirements.", "semantic", "conditional", "error", "local", [citation("6.5.5"), citation("6.5.5.1", "Associated body extension")]),
  requirement("ts119602.service.information", "Service information structure", "Validate mandatory name and digital identity and all conditional components and cross-field presence rules.", "structure", "shall", "critical", "local", [citation("6.6.0")], "partial", ["xml_lote.services.entity.1.service.1.service_name", "xml_lote.services.entity.1.service.1.digital_identity"]),
  requirement("ts119602.service.type", "Service type identifier", "Validate the optional base URI and any selected-profile allowed-value restriction without inventing a universal presence rule.", "semantic", "conditional", "error", "local", [citation("6.6.1")], "partial", ["xml_lote.services.entity.1.service.1.type_identifier"]),
  requirement("ts119602.service.name", "Service name", "Validate multilingual service-name structure and selected-profile semantics.", "semantic", "shall", "error", "local", [citation("6.6.2")], "partial", ["xml_lote.services.entity.1.service.1.service_name"]),
  requirement("ts119602.service.digital_identity", "Service digital identity", "Validate identity alternatives, strict Base64 and DN forms, certificate/key/SKI equivalence, and PKI certificate presence.", "semantic", "shall", "critical", "local", [citation("6.6.3"), citation("6.6.3.1"), citation("6.6.3.2"), citation("6.6.3.3"), citation("6.6.3.4")], "partial", ["xml_lote.services.entity.1.service.1.digital_identity", "xml_lote.certificates.service.1.parse"]),
  requirement("ts119602.service.status", "Service status", "Validate status presence, registered value, and consistency with history period and selected profile.", "semantic", "conditional", "error", "local", [citation("6.6.4")]),
  requirement("ts119602.service.status_start", "Status starting time", "Validate lexical form and consistency with list issuance and current status.", "semantic", "conditional", "error", "local", [citation("6.6.5")]),
  requirement("ts119602.service.scheme_definition", "Scheme service definition URI", "Validate multilingual scheme-level service-definition pointers.", "semantic", "conditional", "error", "mixed", [citation("6.6.6")]),
  requirement("ts119602.service.supply_points", "Service supply points", "Validate service supply-point URI structure and selected-profile machine-processable endpoint rules.", "semantic", "conditional", "error", "mixed", [citation("6.6.7")]),
  requirement("ts119602.service.definition", "TE service definition URI", "Validate multilingual pointers to trusted-entity service information.", "semantic", "conditional", "error", "mixed", [citation("6.6.8")]),
  requirement("ts119602.service.extensions", "Service information extensions", "Validate extension structure and selected-profile service unique identifier requirements.", "semantic", "conditional", "error", "local", [citation("6.6.9"), citation("6.6.9.1", "Service unique identifier extension")]),
  requirement("ts119602.service.history", "Service history instances", "Validate mandatory history fields, ordering, retained identity semantics, and profile-specific restrictions.", "semantic", "conditional", "error", "local", [citation("6.7")]),
  ...
  requirement("ts119602.binding.json_schema", "Official scheme-explicit JSON binding", "Validate the pinned official JSON schema offline and retain semantic checks where document text prevails.", "schema", "shall", "critical", "local", [citation("Annex A.1", "JSON bindings")], "not_implemented", [] , ["scheme_explicit_json"]),
  ...
  requirement("ts119602.language.annex_b", "Normative multilingual implementation", "Apply Annex B character, encoding, pointer, and parser interoperability requirements.", "syntax", "mixed", "error", "mixed", [citation("Annex B")]),
