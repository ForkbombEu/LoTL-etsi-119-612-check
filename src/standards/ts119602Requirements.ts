...
const CORE_REQUIREMENTS = [
  ...
  requirement("ts119602.syntax.uri", "URI syntax", "Validate URI-valued components using RFC 3986 and any component-specific URI scheme rules.", "syntax", "shall", "error", "local", [citation("6.1.2")], "implemented", ["ts119602.syntax.uri", "ts119602.scheme.operator_address", "ts119602.entity.address"]),
  ...
  requirement("ts119602.scheme.sequence.history", "LoTE sequence progression", "Validate the complete sequence from first release, exact increments, issue-time ordering, and the prohibition on resetting across supplied prior list instances.", "contextual", "shall", "error", "contextual", [citation("6.3.2")], "implemented", ["ts119602.scheme.sequence.history"]),
  ...
  requirement("ts119602.scheme.operator_name", "Scheme operator name", "Validate the multilingual scheme-operator name structure and compare the formal name with supplied authoritative evidence.", "semantic", "shall", "error", "mixed", [citation("6.3.4")], "implemented", ["json_lote.scheme_operator_name", "xml_lote.structure.scheme_operator_name", "ts119602.context.authoritative_identity"]),
  requirement("ts119602.scheme.operator_address", "Scheme operator address", "Validate postal and electronic address structure and compare contact claims with supplied authoritative evidence.", "semantic", "conditional", "error", "mixed", [citation("6.3.5"), citation("6.3.5.1"), citation("6.3.5.2")], "implemented", ["ts119602.scheme.operator_address", "xml_lote.structure.scheme_operator_address", "ts119602.context.authoritative_identity"]),
  ...
  requirement("ts119602.scheme.information_uri", "Scheme information URI", "Validate multilingual information pointers, hash-bound reviewed scheme-page semantics, and bounded profile archive traversal.", "semantic", "conditional", "error", "mixed", [citation("6.3.7")], "implemented", ["json_lote.scheme_information_uri", "xml_lote.structure.scheme_information_uri", "ts119602.context.scheme_resources", "ts119602.context.archive"]),
  ...
  requirement("ts119602.scheme.community_rules", "Scheme type/community/rules", "Validate the registered scheme-rules URI and hash-bound reviewed policy/usage semantics where evidence is supplied.", "semantic", "conditional", "error", "mixed", [citation("6.3.9"), citation("Annex C.2.3", "Scheme type/community/rules URIs")], "implemented", ["xml_lote.structure.scheme_type_community_rules", "ts119602.context.scheme_resources"]),
  ...
  requirement("ts119602.scheme.policy_or_legal_notice", "Policy or legal notice", "Validate multilingual policy text/pointer alternatives and hash-bound reviewed pointed-to policy semantics.", "semantic", "conditional", "error", "mixed", [citation("6.3.11")], "implemented", ["ts119602.scheme.policy_or_legal_notice", "xml_lote.structure.policy_or_legal_notice", "ts119602.context.scheme_resources"]),
  ...
  requirement("ts119602.scheme.pointers.authentication", "Pointed-to LoTE authentication", "Require at least one pointer identity to authenticate the pointed-to LoTE before use. Certificate, public-key and SKI forms are implemented with separately supplied path/revocation evidence where configured; open-format OtherId semantics remain profile-dependent.", "contextual", "shall", "critical", "contextual", [citation("6.3.13")], "partial", ["ts119602.scheme.pointers.authentication"]),
  ...
  requirement("ts119602.scheme.next_update", "Next update and closed LoTE", "Validate ordering, expiry, profile update interval, and final null/expired-service semantics using explicit scheme status policy where required.", "semantic", "mixed", "error", "mixed", [citation("6.3.15")], "implemented", ["ts119602.scheme.next_update", "json_lote.dates.next_after_issue", "json_lote.dates.next_update_expired", "xml_lote.dates.next_after_issue", "ts119602.scheme.final_closed_list"]),
  ...
  requirement("ts119602.scheme.distribution_consistency", "Distribution point consistency", "Dereference supplied distribution points and verify that each returns the current identical LoTE.", "contextual", "shall", "error", "contextual", [citation("6.3.16")], "implemented", ["ts119602.scheme.distribution_consistency"]),
  ...
  requirement("ts119602.entities.structure", "Trusted entity and service containers", "Validate TrustedEntityInformation, TrustedEntityServices, TrustedEntityService, and optional history nesting and cardinality.", "structure", "shall", "critical", "local", [citation("6.4.1"), citation("6.4.2"), citation("6.4.3"), citation("6.4.4")], "implemented", ["ts119602.entities.structure"]),
  requirement("ts119602.entity.information", "Trusted entity information", "Validate mandatory name, address, information URI, optional trade name, and extensions.", "structure", "shall", "critical", "local", [citation("6.5.0")], "implemented", ["ts119602.entity.information"]),
  requirement("ts119602.entity.names", "Trusted entity names", "Validate legal/natural-person names, registration identifiers, and supplied authoritative-record consistency.", "semantic", "mixed", "error", "mixed", [citation("6.5.1"), citation("6.5.2")], "implemented", ["ts119602.entity.names", "xml_lote.services.entity.1.name", "ts119602.context.authoritative_identity"]),
  requirement("ts119602.entity.address", "Trusted entity address", "Validate multilingual postal/electronic addresses and compare contact claims with supplied authoritative evidence.", "semantic", "shall", "error", "mixed", [citation("6.5.3"), citation("6.5.3.1"), citation("6.5.3.2")], "implemented", ["ts119602.entity.address", "xml_lote.services.entity.1.address", "ts119602.context.authoritative_identity"]),
  ...
  requirement("ts119602.service.information", "Service information structure", "Validate mandatory name and digital identity and all conditional components and cross-field presence rules.", "structure", "shall", "critical", "local", [citation("6.6.0")], "implemented", ["ts119602.service.information", "ts119602.service.status"]),
  ...
  requirement("ts119602.service.supply_points", "Service supply points", "Validate service supply-point URI structure and selected-profile machine-processable endpoint rules.", "semantic", "conditional", "error", "mixed", [citation("6.6.7")], "partial", ["ts119602.service.supply_points", "ts119602.context.supply_point"]),
  ...
  requirement("ts119602.binding.xml_schema", "Official scheme-explicit XML binding", "Validate the pinned official XML schema offline and retain semantic checks where document text prevails.", "schema", "shall", "critical", "local", [citation("Annex A.2.1", "ETSI TS 119 602 schema")], "implemented", ["ts119602.binding.xml_schema", "xml_lote.structure.xml_binding"], ["scheme_explicit_xml"]),
  requirement("ts119602.binding.ts119612_mapping", "TS 119 612 alternative XML binding", "Validate the applicable TS 119 612 schema and map components through Table A.1 before applying TS 119 602 profile rules.", "binding", "shall", "critical", "local", [citation("Annex A.2.2", "ETSI TS 119 612 schema"), citation("Table A.1", "Mapping of TS 119 612 fields to TS 119 602 components")], "implemented", ["ts119602.binding.ts119612_mapping", "ts119602.profile.mapping_gate", "ts119602.binding.ts119612_mapping.version_conflict"], ["ts119612_alternative_xml"]),
  requirement("ts119602.language.annex_b", "Normative multilingual implementation", "Apply Annex B native-term transliteration, character-string, pointer-content, and parser interoperability requirements.", "syntax", "mixed", "error", "mixed", [citation("Annex B")], "partial", ["ts119602.language.transliteration", "ts119602.language.annex_b"]),
