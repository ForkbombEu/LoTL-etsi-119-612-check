...
const CORE_REQUIREMENTS = [
  ...
  requirement("ts119602.scheme.sequence.history", "LoTE sequence progression", "Validate first-release value, monotonic increase, and the prohibition on resetting across supplied prior list instances.", "contextual", "shall", "error", "contextual", [citation("6.3.2")], "partial", ["ts119602.scheme.sequence.history"]),
  ...
  requirement("ts119602.scheme.information_uri", "Scheme information URI", "Validate multilingual information pointers and profile-specific information/archive targets.", "semantic", "conditional", "error", "mixed", [citation("6.3.7")], "partial", ["json_lote.scheme_information_uri", "xml_lote.structure.scheme_information_uri", "ts119602.context.archive"]),
