...
const CORE_REQUIREMENTS = [
  ...
  requirement("ts119602.scheme.pointers.authentication", "Pointed-to LoTE authentication", "Require at least one pointer identity to authenticate the pointed-to LoTE before use.", "contextual", "shall", "critical", "contextual", [citation("6.3.13")], "partial", ["ts119602.scheme.pointers.authentication"]),
