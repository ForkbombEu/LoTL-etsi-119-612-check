...
export const TS119612_REQUIREMENTS: readonly Ts119612Requirement[] = Object.freeze([
  ...
  requirement("ts119612.scheme.version", "TSL version identifier", "Require the integer format-version value 6 for V2.4.1.", "semantic", "shall", "critical", "local", [cite("5.3.1")], "implemented", ["structure.tsl_version_identifier", "structure.tsl_version_identifier.value", "ts119612.scheme.version"]),
  ...
  requirement("ts119612.scheme.sequence.history", "TSL sequence progression", "Validate first-release value, monotonic increment and the prohibition on recycling across supplied prior instances.", "contextual", "shall", "error", "contextual", [cite("5.3.2")], "implemented", ["ts119612.scheme.sequence.history"]),
  ...
  requirement("ts119612.scheme.history_period", "Historical information period", "Validate mandatory integer history period and its consequences for retained service history.", "semantic", "shall", "error", "mixed", [cite("5.3.12")], "partial", ["ts119612.scheme.history_period", "ts119612.context.history_retention"]),
  requirement("ts119612.scheme.pointers.structure", "Pointers to other TSLs", "Validate pointer location, service digital identities, type/operator/community/territory/MIME qualifiers, signing-certificate metadata, rollover evidence and supported target-profile dispatch.", "structure", "conditional", "error", "local", [cite("5.3.13"), cite("6.2"), cite("Annex A")], "implemented", ["ts119612.scheme.pointers.structure", "ts119612.pointer.1.structure", "ts119612.pointer.1.location", "ts119612.pointer.1.identities", "ts119612.pointer.1.qualifiers", "ts119612.pointer.1.dispatch", "ts119612.pointer.1.signing_certificates", "ts119612.pointer.1.rollover"], BOTH_ARTIFACT_KINDS),
  requirement("ts119612.scheme.pointers.authentication", "Pointed-list authentication", "Authenticate a pointed list using at least one declared service identity before its contents are used.", "contextual", "shall", "critical", "contextual", [cite("5.3.13"), cite("Annex A")], "implemented", ["ts119612.scheme.pointers.authentication", "ts119612.context.traversal"], BOTH_ARTIFACT_KINDS),
  ...
  requirement("ts119612.scheme.distribution_consistency", "Distribution consistency", "Dereference supplied distribution points and compare the returned binary TL with the assessed instance.", "contextual", "shall", "error", "contextual", [cite("5.3.16"), cite("6.1")], "implemented", ["ts119612.scheme.distribution_consistency"]),
  ...
  requirement("ts119612.service.digital_identity", "Service digital identity", "Validate mandatory identity alternatives, equivalence, PKI/non-PKI rules and certificate evidence.", "semantic", "shall", "critical", "local", [cite("5.5.3")], "partial", ["services.tsp.1.service.1.digital_identity", "ts119612.service.1.1.digital_identity", "ts119612.service.1.1.identity_equivalence", "ts119612.service.identity_uniqueness", "ts119612.service.1.1.certificate_role", "ts119612.service.1.1.certificate_subject_tsp_name", "certificates.service.1.parse", "certificates.service.1.validity"], TL_ONLY),
  requirement("ts119612.service.status", "Service current status", "Validate mandatory registered status and its consistency with type, history and applicable legal context.", "semantic", "shall", "critical", "local", [cite("5.5.4"), cite("Annex D")], "partial", ["services.tsp.1.service.1.status", "ts119612.service.1.1.status", "ts119612.service.1.1.history.1.status_transition"], TL_ONLY),
  ...
  requirement("ts119612.service.extensions", "Service information extensions", "Validate extension structure, criticality and cross-field semantics.", "semantic", "conditional", "critical", "local", [cite("5.5.9"), cite("Annex B.0")], "partial", ["ts119612.service.1.1.extensions", "ts119612.service.1.1.extension.1.expired_certs", "ts119612.service.1.1.extension.2.qualifications", "ts119612.service.1.1.extension.3.taken_over_by", "ts119612.service.1.1.extension.4.additional_information"], TL_ONLY),
  requirement("ts119612.service.extension.expired_certs", "Expired certificate revocation extension", "Validate expiredCertsRevocationInfo structure and applicability.", "semantic", "conditional", "error", "local", [cite("5.5.9.1")], "partial", ["ts119612.service.1.1.extension.1.expired_certs"], TL_ONLY),
  requirement("ts119612.service.extension.qualifications", "Qualifications extension", "Validate QualificationElement, CriteriaList and Qualifier rules.", "semantic", "conditional", "error", "local", [cite("5.5.9.2")], "partial", ["ts119612.service.1.1.extension.2.qualifications"], TL_ONLY),
  requirement("ts119612.service.extension.taken_over_by", "TakenOverBy extension", "Validate takeover identity, service and status relationships.", "semantic", "conditional", "error", "local", [cite("5.5.9.3")], "partial", ["ts119612.service.1.1.extension.3.taken_over_by"], TL_ONLY),
  requirement("ts119612.service.extension.additional_information", "Additional service information extension", "Validate registered additional-service identifiers and service-type dependencies.", "semantic", "conditional", "error", "local", [cite("5.5.9.4"), cite("Annex D")], "partial", ["ts119612.service.1.1.extension.4.additional_information"], TL_ONLY),
  requirement("ts119612.service.history", "Service history list", "Validate optional history presence, descending order and retention completeness.", "semantic", "conditional", "error", "mixed", [cite("5.5.10"), cite("5.3.12")], "partial", ["ts119612.service.1.1.history.structure", "ts119612.service.1.1.history.retention", "ts119612.context.history_retention"], TL_ONLY),
  requirement("ts119612.history.type", "Historical service type", "Validate mandatory service type within each history instance.", "semantic", "shall", "error", "local", [cite("5.6.1")], "partial", ["ts119612.service.1.1.history.1.type"], TL_ONLY),
  requirement("ts119612.history.name", "Historical service name", "Validate mandatory multilingual service name within each history instance.", "semantic", "shall", "error", "local", [cite("5.6.2")], "implemented", ["ts119612.service.1.1.history.1.name"], TL_ONLY),
  requirement("ts119612.history.digital_identity", "Historical service identity", "Validate mandatory historical identity and continuity/equivalence rules.", "semantic", "shall", "critical", "local", [cite("5.6.3")], "partial", ["ts119612.service.1.1.history.1.digital_identity"], TL_ONLY),
  requirement("ts119612.history.status", "Historical service status", "Validate mandatory registered previous status and transition semantics.", "semantic", "shall", "error", "local", [cite("5.6.4"), cite("Annex D")], "partial", ["ts119612.service.1.1.history.1.status", "ts119612.service.1.1.history.1.status_transition"], TL_ONLY),
  requirement("ts119612.history.status_start", "Historical status starting time", "Validate mandatory UTC time and ordering across history instances.", "semantic", "shall", "error", "local", [cite("5.6.5")], "implemented", ["ts119612.service.1.1.history.1.status_start"], TL_ONLY),
  requirement("ts119612.history.extensions", "Historical service extensions", "Validate optional history extension structure and semantics.", "semantic", "conditional", "error", "local", [cite("5.6.6")], "partial", ["ts119612.service.1.1.history.1.extensions"], TL_ONLY),
  requirement("ts119612.signature.required", "Digitally signed trusted list", "Require an enveloped XAdES-B-B signature by the scheme operator.", "signature", "shall", "critical", "local", [cite("5.7.1"), cite("Annex B.1")], "implemented", ["signature.present", "signature.xades_baseline_b.structure", "ts119612.signature.annex_b"]),
  requirement("ts119612.signature.algorithm", "Signature algorithm", "Validate the signature algorithm and certified key against the applicable ETSI TS 119 312 usable-key requirements.", "signature", "shall", "critical", "local", [cite("5.7.1"), cite("5.7.2")], "partial", ["ts119612.signature.algorithm_identifier", "ts119612.signature.algorithm_policy", "signature.cryptographic_verification_result"]),
  requirement("ts119612.signature.document_coverage", "Signature value and document coverage", "Validate the signature value, enveloped reference, exact transforms/canonicalization and coverage of every TL field except the signature value.", "signature", "shall", "critical", "local", [cite("5.7.3"), cite("Annex B.1")], "implemented", ["ts119612.signature.annex_b", "ts119612.signature.algorithm_identifier", "signature.reference_uris", "signature.expected_root_reference", "signature.cryptographic_verification_result"]),
  requirement("ts119612.signature.certificate_profile", "Scheme-operator signing certificate", "Validate KeyInfo cardinality, issuer, subject matching, key usage, extended key usage, SKI and basic constraints.", "signature", "shall", "critical", "local", [cite("5.7.1")], "partial", ["ts119612.signature.key_info", "ts119612.signature.certificate.issuer", "ts119612.signature.certificate.key_usage", "ts119612.signature.certificate.extended_key_usage", "ts119612.signature.certificate.subject_key_identifier", "ts119612.signature.certificate.basic_constraints", "signature.signer_subject.country", "signature.signer_subject.organization"]),
  requirement("ts119612.signature.signer_trust", "Scheme-operator signer trust", "Authenticate the signing certificate using explicit LOTL, community or directly configured trust evidence without trusting KeyInfo by itself.", "contextual", "shall", "critical", "contextual", [cite("5.7.1"), cite("Annex A")], "partial", ["ts119612.signature.certificate_path", "ts119612.signature.revocation", "ts119612.signature.signer_trust"]),
