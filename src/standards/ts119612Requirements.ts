...
export const TS119612_REQUIREMENTS: readonly Ts119612Requirement[] = Object.freeze([
  ...
  requirement("ts119612.scheme.pointers.authentication", "Pointed-list authentication", "Authenticate a pointed list using at least one declared service identity before its contents are used.", "contextual", "shall", "critical", "contextual", [cite("5.3.13"), cite("Annex A")], "not_implemented", ["ts119612.scheme.pointers.authentication"], BOTH_ARTIFACT_KINDS),
  ...
  requirement("ts119612.service.history", "Service history list", "Validate optional history presence, descending order and retention completeness.", "semantic", "conditional", "error", "mixed", [cite("5.5.10"), cite("5.3.12")], "partial", ["ts119612.service.1.1.history.structure", "ts119612.service.1.1.history.retention"], TL_ONLY),
