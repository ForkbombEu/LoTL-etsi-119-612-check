...
export const TS119612_REQUIREMENTS: readonly Ts119612Requirement[] = Object.freeze([
  ...
  requirement("ts119612.syntax.uri", "URI syntax", "Validate every URI-valued component using RFC 3986 and component-specific schemes.", "syntax", "shall", "error", "local", [cite("5.1.2")], "not_implemented"),
  ...
  requirement("ts119612.syntax.language", "Language and multilingual values", "Validate multilingual strings/pointers, language tags, required English coverage and transliteration rules.", "syntax", "mixed", "error", "local", [cite("5.1.4"), cite("Annex E")], "not_implemented"),
  requirement("ts119612.syntax.country_code", "Country-code values", "Validate upper-case ISO 3166-1 values and the defined UK, EL, EU, regional and multi-state alternatives.", "syntax", "shall", "error", "local", [cite("5.1.5")], "not_implemented"),
  ...
  requirement("ts119612.scheme.sequence.local", "TSL sequence number", "Validate mandatory integer shape and locally decidable range constraints.", "semantic", "shall", "error", "local", [cite("5.3.2")], "partial", ["structure.tsl_sequence_number"]),
  ...
  requirement("ts119612.scheme.type", "TSL type", "Validate the mandatory registered type URI and the structure selected by that type.", "semantic", "shall", "critical", "local", [cite("5.3.3"), cite("Annex D")], "partial", ["structure.tsl_type"]),
  requirement("ts119612.scheme.operator_name", "Scheme operator name", "Validate mandatory multilingual operator-name structure and applicable EU/non-EU semantics.", "semantic", "shall", "error", "local", [cite("5.3.4")], "partial", ["structure.scheme_operator_name"]),
  requirement("ts119612.scheme.operator_address", "Scheme operator address", "Validate postal/electronic address cardinality, languages, country, email and web URI rules.", "semantic", "shall", "error", "local", [cite("5.3.5"), cite("5.3.5.1"), cite("5.3.5.2")], "partial", ["structure.scheme_operator_address"]),
  requirement("ts119612.scheme.name", "Scheme name", "Validate multilingual scheme-name structure and territory/name conventions.", "semantic", "shall", "error", "local", [cite("5.3.6")], "partial", ["structure.scheme_name"]),
  requirement("ts119612.scheme.information_uri", "Scheme information URI", "Validate mandatory multilingual pointers and the required policy/usage information at supplied targets.", "semantic", "shall", "error", "mixed", [cite("5.3.7")], "partial", ["structure.scheme_information_uri"]),
  requirement("ts119612.scheme.status_determination", "Status determination approach", "Validate registered EU or scheme-defined status-determination values.", "semantic", "shall", "error", "local", [cite("5.3.8"), cite("Annex D.5.2")], "partial", ["structure.status_determination_approach", "structure.status_determination_approach.value"]),
  requirement("ts119612.scheme.community_rules", "Scheme type/community/rules", "Validate mandatory ordered policy pointers and EUcommon/national rule semantics where applicable.", "semantic", "shall", "error", "mixed", [cite("5.3.9"), cite("Annex D")], "partial", ["structure.scheme_type_community_rules"]),
  requirement("ts119612.scheme.territory", "Scheme territory", "Validate the mandatory country/territory value and its consistency with scheme and signer metadata.", "semantic", "shall", "error", "local", [cite("5.3.10")], "partial", ["structure.scheme_territory"]),
  requirement("ts119612.scheme.policy_or_legal_notice", "TSL policy/legal notice", "Validate multilingual policy text/pointer alternatives and applicable EU legal-notice content.", "semantic", "shall", "error", "mixed", [cite("5.3.11")], "not_implemented"),
  requirement("ts119612.scheme.history_period", "Historical information period", "Validate mandatory integer history period and its consequences for retained service history.", "semantic", "shall", "error", "mixed", [cite("5.3.12")], "not_implemented"),
  ...
  requirement("ts119612.scheme.issue_time", "List issue date and time", "Validate mandatory lexical form and consistency with signing/status-change evidence.", "semantic", "shall", "error", "mixed", [cite("5.3.14"), cite("5.5.5")], "partial", ["structure.list_issue_date_time", "dates.issue_valid"]),
  requirement("ts119612.scheme.next_update", "Next update", "Validate mandatory date, ordering, expiry and the exact applicable maximum update interval.", "semantic", "shall", "error", "mixed", [cite("5.3.15")], "partial", ["structure.next_update", "dates.next_update_valid", "dates.next_after_issue", "dates.update_period_days", "dates.next_update_expired"]),
  requirement("ts119612.scheme.distribution_points", "Distribution points", "Validate optional distribution-point URI structure and stable publication semantics.", "structure", "conditional", "error", "mixed", [cite("5.3.16")], "partial", ["structure.distribution_points"]),
  ...
  requirement("ts119612.scheme.extensions", "Scheme extensions", "Validate extension structure/criticality and reject unrecognized critical extensions.", "semantic", "conditional", "critical", "local", [cite("5.3.17"), cite("Annex B.0")], "not_implemented"),
  requirement("ts119612.providers.list", "Trust service provider list", "Validate presence/absence and exact provider-list nesting selected by TSL type.", "structure", "conditional", "critical", "local", [cite("5.3.18")], "partial", ["structure.trust_service_provider_list", "services.tsp_count"], TL_ONLY),
  requirement("ts119612.tsp.name", "TSP name", "Validate mandatory multilingual legal-name structure.", "semantic", "shall", "error", "local", [cite("5.4.1")], "partial", ["services.tsp.1.name"], TL_ONLY),
  requirement("ts119612.tsp.trade_name", "TSP trade name", "Validate optional multilingual trade-name semantics.", "semantic", "conditional", "error", "local", [cite("5.4.2")], "not_implemented", [], TL_ONLY),
  requirement("ts119612.tsp.address", "TSP address", "Validate mandatory postal/electronic address structures and contact semantics.", "semantic", "shall", "error", "local", [cite("5.4.3"), cite("5.4.3.1"), cite("5.4.3.2")], "partial", ["services.tsp.1.address"], TL_ONLY),
  requirement("ts119612.tsp.information_uri", "TSP information URI", "Validate mandatory multilingual information pointers.", "semantic", "shall", "error", "mixed", [cite("5.4.4")], "not_implemented", [], TL_ONLY),
  requirement("ts119612.tsp.extensions", "TSP information extensions", "Validate extension structure, criticality and recognized semantics.", "semantic", "conditional", "critical", "local", [cite("5.4.5"), cite("Annex B.0")], "not_implemented", [], TL_ONLY),
  requirement("ts119612.tsp.services", "TSP services list", "Validate mandatory non-empty TSPServices/TSPService nesting and cardinality.", "structure", "shall", "critical", "local", [cite("5.4.6")], "partial", ["services.tsp.1.service_count"], TL_ONLY),
  requirement("ts119612.service.type", "Service type identifier", "Validate mandatory registered service-type values and conditional identity/extension rules.", "semantic", "shall", "critical", "local", [cite("5.5.1"), cite("5.5.1.1"), cite("5.5.1.2"), cite("5.5.1.3"), cite("Annex D")], "partial", ["services.tsp.1.service.1.type_identifier"], TL_ONLY),
  requirement("ts119612.service.name", "Service name", "Validate mandatory multilingual service-name structure.", "semantic", "shall", "error", "local", [cite("5.5.2")], "partial", ["services.tsp.1.service.1.service_name"], TL_ONLY),
  requirement("ts119612.service.digital_identity", "Service digital identity", "Validate mandatory identity alternatives, equivalence, PKI/non-PKI rules and certificate evidence.", "semantic", "shall", "critical", "local", [cite("5.5.3")], "partial", ["services.tsp.1.service.1.digital_identity", "certificates.service.1.parse", "certificates.service.1.validity"], TL_ONLY),
  requirement("ts119612.service.status", "Service current status", "Validate mandatory registered status and its consistency with type, history and applicable legal context.", "semantic", "shall", "critical", "local", [cite("5.5.4"), cite("Annex D")], "partial", ["services.tsp.1.service.1.status"], TL_ONLY),
  requirement("ts119612.service.status_start", "Current status starting time", "Validate mandatory UTC time and consistency with issuance and status-change evidence.", "semantic", "shall", "error", "local", [cite("5.5.5")], "partial", ["services.tsp.1.service.1.status_starting_time"], TL_ONLY),
  requirement("ts119612.service.scheme_definition", "Scheme service definition URI", "Validate optional multilingual scheme-level service-definition pointers.", "semantic", "conditional", "error", "mixed", [cite("5.5.6")], "not_implemented", [], TL_ONLY),
  requirement("ts119612.service.supply_points", "Service supply points", "Validate optional supply-point URI structure and content required by the service type.", "semantic", "conditional", "error", "mixed", [cite("5.5.7")], "not_implemented", [], TL_ONLY),
  requirement("ts119612.service.tsp_definition", "TSP service definition URI", "Validate optional multilingual provider-level service-definition pointers.", "semantic", "conditional", "error", "mixed", [cite("5.5.8")], "not_implemented", [], TL_ONLY),
  requirement("ts119612.service.extensions", "Service information extensions", "Validate extension structure, criticality and cross-field semantics.", "semantic", "conditional", "critical", "local", [cite("5.5.9"), cite("Annex B.0")], "not_implemented", [], TL_ONLY),
